  ...
  return (
    ...
    <div className="text-center p-10 bg-gray-100 min-h-screen">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-xl font-semibold text-green-600">Upcoming Plays</h2>
          <p className="mt-2 text-gray-600">Don't miss out on the most anticipated plays.</p>
          <Link to="/shows">
          <button className="mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">Explore Plays</button>
        </Link>
        </div>
        <div className="bg-white shadow-md rounded-lg p-6">
